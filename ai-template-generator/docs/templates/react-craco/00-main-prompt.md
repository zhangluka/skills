# React+Craco项目模板生成AI指令

## 🎯 任务目标

你是一个专业的前端项目生成专家，需要根据以下规范生成一个完整的、可直接部署的React+Craco项目模板。
...
### 第2步：生成项目基础
- 创建标准的React+TypeScript项目结构
- 集成Craco作为构建配置工具
- 配置开发环境和生产环境

### 第3步：应用魔改配置
重点参考`02-craco-modifications.md`，应用所有自定义webpack配置。
...
### 第6步：验证完整性
确保生成的项目包含所有必要的文件和配置，可以直接`npm install`和`npm start`。
...
2. **02-craco-modifications.md** - Craco魔改详细配置
...
现在请按照上述步骤和要求，生成一个完整的React+Craco项目模板。如需了解具体细节，请参考对应的支持文档。